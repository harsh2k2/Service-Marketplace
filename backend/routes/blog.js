...
//   });
//   const sql =
//     "INSERT INTO blog (blog_name,slug, full_description, blog_image, isActive, date_created) VALUES (?, ?, ?, ?, ?, ?)";
//   db.query(
//     sql,
//     [blog_name, slug, full_description, blog_image, isActive, date_created],
//     (err, results) => {
//       if (err) {
//         console.log(err);
//         res
